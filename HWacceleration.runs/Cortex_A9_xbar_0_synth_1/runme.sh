...
HD_PWD='C:/Users/kmd17/Documents/GitHub/Embedded_Systems_lab4_HW_SW_ACCELERATION/HWacceleration.runs/Cortex_A9_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Cortex_A9_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Cortex_A9_xbar_0.tcl
