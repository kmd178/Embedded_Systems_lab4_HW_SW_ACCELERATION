...
HD_PWD='c:/users/kmd17/documents/github/embedded_systems_lab4_hw_sw_acceleration/hwacceleration.tmp/handshake_v2_0_project/handshake_v2_0_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log handshake_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source handshake_v1_0.tcl -notrace
