...
HD_PWD='c:/users/kmd17/documents/github/embedded_systems_lab4_hw_sw_acceleration/hwacceleration.tmp/axi_lite_kmd_edit_v2_0_project/AXI_Lite_kmd_edit_v2_0_project.runs/synth_1'
cd "$HD_PWD"
